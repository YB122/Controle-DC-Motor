...
# 64 "MCAL_Layer/GPIO/../device_config.h" 2
...
# 4 "MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 6 "MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 4 "MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "MCAL_Layer/GPIO/../compiler.h" 1
# 5 "MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
std_ReturneType gpio_pin_direction_intialize(const pin_config_t *_pin_config)
{
    ...
    else
    {
        ...
        {
            case OUTPUT :
                ((*((volatile uint8 *)(tris_register[_pin_config->port]))) &= ~((uint8)1 << _pin_config->pin));
                break;
            case INPUT:
                ((*((volatile uint8 *)(tris_register[_pin_config->port]))) |= ((uint8)1 << _pin_config->pin));
                break;
...
{
    std_ReturneType ret = (std_ReturneType)0x01 ;
    if((_pin_config == ((void*)0)) || (direction_status == ((void*)0)) || (_pin_config->pin > 8 -1))
        ret = (std_ReturneType)0x00 ;
    else
    {
        *direction_status = (((*((volatile uint8 *)(tris_register[_pin_config->port]))) >> _pin_config->pin) & (uint8)1);
    }
    return ret ;
}
# 61 "MCAL_Layer/GPIO/hal_gpio.c"
std_ReturneType gpio_pin_write_logic(const pin_config_t *_pin_config , uint8 logic)
{
    std_ReturneType ret = (std_ReturneType)0x01 ;
    if((_pin_config == ((void*)0)) || (_pin_config->pin > 8 -1))
    ...
    else
    {
        ...
        {
            case LOW :
                ((*((volatile uint8 *)(lat_register[_pin_config->port]))) &= ~((uint8)1 << _pin_config->pin));
                break;
            case HIGH:
                ((*((volatile uint8 *)(lat_register[_pin_config->port]))) |= ((uint8)1 << _pin_config->pin));
                break;
...
std_ReturneType gpio_pin_read_logic(const pin_config_t *_pin_config , uint8 *logic)
{
    ...
    {
        *logic = (((*((volatile uint8 *)(port_register[_pin_config->port]))) >> _pin_config->pin) & (uint8)1);
    }
    return ret ;
}
