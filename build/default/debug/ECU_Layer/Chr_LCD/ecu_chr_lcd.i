...
# 64 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 4 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 6 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 7 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 4 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../compiler.h" 1
# 5 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
# 35 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum
{
    LOW,
    HIGH
...
# 4 "ECU_Layer/Chr_LCD/ecu_chr_lcd.h" 2
...
std_ReturneType lcd_4_intialize(chr_lcd_4bit_t *lcd)
{
    ...
    else
    {
        ...
        ret = lcd_4_send_command(lcd , 0X38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        ret = lcd_4_send_command(lcd , 0X38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        ret = lcd_4_send_command(lcd , 0X38);
        ret = lcd_4_send_command(lcd , 0X01);
        ret = lcd_4_send_command(lcd , 0X02);
        ret = lcd_4_send_command(lcd , 0X06);
        ret = lcd_4_send_command(lcd , 0X0C);
        ret = lcd_4_send_command(lcd , 0X28);
        ret = lcd_4_send_command(lcd , 0X80);
    }
    return ret ;
}
                                        ...
                                        uint8 mem_pos)
{
    ...
    {
        ret = lcd_4_send_command(lcd , 0X40 + (mem_pos * 8));
...
std_ReturneType lcd_8_intialize(chr_lcd_8bit_t *lcd)
{
    ...
    else
    {
        ...
        _delay((unsigned long)((20)*(8000000/4000.0)));
        ret = lcd_8_send_command(lcd , 0X38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        ret = lcd_8_send_command(lcd , 0X38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        ret = lcd_8_send_command(lcd , 0X38);
        ret = lcd_8_send_command(lcd , 0X01);
        ret = lcd_8_send_command(lcd , 0X02);
        ret = lcd_8_send_command(lcd , 0X06);
        ret = lcd_8_send_command(lcd , 0X0C);
        ret = lcd_8_send_command(lcd , 0X38);
        ret = lcd_8_send_command(lcd , 0X80);
    }
    return ret ;
}
                                        ...
                                        uint8 mem_pos)
{
    ...
    {
        ret = lcd_8_send_command(lcd , 0X40 + (mem_pos * 8));
        for(counter = 0 ; counter < 8 ; counter++)
        {
